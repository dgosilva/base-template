...
export default function App() {
  ...
  const filteredMovies = movies.filter((movie) => {
    ...
    const matchesFilter =
      filter === "all" || (filter === "high" && movie.rating >= 4.5) || (filter === "low" && movie.rating < 4.5);
      ...
      <div className="mb-4">
        ...
        <Select value={filter} onValueChange={setFilter}>
          ...
          <SelectContent>
            ...
            <SelectItem value="high">High rated (≥4.5)</SelectItem>
            <SelectItem value="low">Low rated (&lt;4.5)</SelectItem>
          </SelectContent>
        </Select>
      </div>
